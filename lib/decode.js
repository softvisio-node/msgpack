...
import DecodeKeyCache from "#lib/DecodeKeyCache";
...
export function decode ( buffer, stream ) {
...
class Transform extends stream.Transform {
    ...
    _transform ( data, encoding, callback ) {
        ...
        while ( 1 ) {
            try {
                const [msg, length] = decode( this.#buf, true );
...
decode.pipe = function pipe ( stream ) {
